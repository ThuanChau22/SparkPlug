...
const DriverChartRevenueByStationWidget = ({ className = "", style = {} }) => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const baseURL = `${StationAnalyticsAPI}/charts/driver-revenue-by-station`;
  ...
  return (
    <ChartWidgetContainer
      className={className}
      style={style}
      label="Driver Revenue by Station"
      chart={{
        type: "bar",
        data: data,
        options: {
...
export default DriverChartRevenueByStationWidget;
